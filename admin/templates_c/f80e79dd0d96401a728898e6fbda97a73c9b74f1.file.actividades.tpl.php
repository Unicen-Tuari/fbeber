<?php /* Smarty version Smarty-3.1.14, created on 2016-11-24 20:59:26
...
);" type="button" data-toggle="modal" data-target="#mostrarImages"><span class="glyphicon glyphicon-camera" aria-hidden="true"></span></button></td>
...
<div class="modal-body">
  ...
  <div class="modal-footer">
    ...
    <button type="submit" class="btn btn-success" aria-hidden="true" >Agregar</button>
  </div>
</form>
</div>
</div>
