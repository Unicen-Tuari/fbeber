...
$("#actividades_admin").on("click",function() {loadRender("index.php?action=actividades_admin", function(){ setHandlersActividades();})});
...
function loadRender(etiqueta,callback) {//OK
 $.ajax({
  method: "GET",
  url:etiqueta,
  error: function () {
