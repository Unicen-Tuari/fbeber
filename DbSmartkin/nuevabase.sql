...
INSERT INTO smartkin.usuario (id_usuario, contrasenia, nombre_usuario, email) VALUES
(1, 'admin', 'admin', 'florenciadaianabeber@gmail.com');

INSERT INTO smartkin.categoria (id_categoria, nombre_categoria)VALUES 
(1,'Dibujos Animados'),(2,'Peliculas'),(3,'Comics'),(4,'Musica'),(5,'Automoviles');
...
DROP TABLE if exists smartkin.admin cascade;
CREATE TABLE smartkin.admin(
...
DROP TABLE if exists smartkin.coleccionFavorita cascade;
CREATE TABLE smartkin.coleccionFavorita(
	id_coleccionFavorita int NOT NULL AUTO_INCREMENT,
	id_coleccion int,
	PRIMARY KEY (id_coleccionFavorita)
);

DROP TABLE if exists smartkin.modeloFavorito cascade;
CREATE TABLE smartkin.modeloFavorito(
	id_modelofavorito int NOT NULL AUTO_INCREMENT,
	id_modelo int,
	PRIMARY KEY (id_modelofavorito)
);

DROP TABLE if exists smartkin.id_portfolio cascade;
CREATE TABLE smartkin.portfolio(
	id_portfolio int NOT NULL AUTO_INCREMENT,
	nombre_portfolio varchar (250) NOT NULL,
	img_portfolio varchar (500) NOT NULL,
	PRIMARY KEY (id_portfolio)
);

ALTER TABLE smartkin.modeloFavorito
  ADD CONSTRAINT fk_modeloFavorito
  FOREIGN KEY (id_modelo) REFERENCES modelo (id_modelo);


ALTER TABLE smartkin.coleccionFavorita
  ADD CONSTRAINT fk_coleccionFavorita
  FOREIGN KEY (id_coleccion) REFERENCES coleccion (id_coleccion);

INSERT INTO smartkin.admin (id_admin, contrasenia, username, email, direccion, telefono) VALUES
(1, 'admin', 'admin', 'florenciadaianabeber@gmail.com', 'calle falsa 123', 0303456);
