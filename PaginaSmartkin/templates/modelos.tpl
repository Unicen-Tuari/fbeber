...
{foreach $modelos as $dato}          
  <img  data-toggle="modal" data-target="#myModal" class="img-thumbnail" src="./images/catalogo/{$dato.img_modelo}" onClick = "getDataModelos({$dato.id_modelo});" alt="{$dato.nombre_modelo}">
  Agregar a Favoritos
  Consultar
{/foreach}
