...
insert into inscripcion(id_usuario,id_profe) values
	(1,2),(2,2),(3,3);

insert into comentario(comentario,puntaje,id_usuario,id_act) values
	("me encanta esta actividad", 5, 1, 2),
	("me encanta esta actividad", 5, 2, 2),
	("me encanta esta actividad", 5, 3, 2),
	("no me agrada del todo", 1, 1, 3),
	("no me agrada del todo", 1, 2, 3),
	("no me agrada del todo", 1, 3, 3);
