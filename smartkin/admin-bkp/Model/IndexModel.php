...
//USUARIOS
  ...
  function getCantUsuarios(){
    $consulta = $this->db->prepare("SELECT count(*) as cantidad FROM usuario");
    $consulta->execute();
    $cantusuarios = $consulta->fetchAll(PDO::FETCH_ASSOC);
...
//COMENTARIOS
  ...
  function borrarComentario($id_comentario){
   ...
   function getCantComentarios(){
    $consulta = $this->db->prepare("SELECT COUNT(*) AS cantidad FROM comentario");
    $consulta->execute();
    $cantcomentarios = $consulta->fetchAll(PDO::FETCH_ASSOC);
...
//Insertar las imagenes
 ...
 function getCantFavoritos(){
    $consulta = $this->db->prepare("SELECT COUNT(*) AS cantidad FROM favorito JOIN modelo JOIN coleccion
                                    WHERE favorito.fk_id_mod=modelo.id_mod AND modelo.fk_id_col=coleccion.id_col");
    $consulta->execute();
    $cantfavoritos = $consulta->fetchAll(PDO::FETCH_ASSOC);
