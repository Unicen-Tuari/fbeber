...
{if isset($portfolios)}
<button type="button" class="btn btn-success" data-toggle="modal" data-target="#myModalPort">
  Nuevo Portfolio
</button>
...
<table class="table table-bordered table-hover">
    ...
    <thead>
      ...
      <tr>
          <td>
          <form action="admin_portfolios.php?action=modificar_name_port&id_port={$portfolio['id_port']}" method="POST" enctype="multipart/form-data">
